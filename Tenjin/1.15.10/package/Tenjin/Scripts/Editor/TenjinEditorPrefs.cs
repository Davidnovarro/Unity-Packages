...
namespace TenjinSDK
{
    class TenjinEditorPrefs : IPreprocessBuildWithReport
    {
        ...
        {
            var ironsourceTypes = new[] { "IronSource", "IronSourceEvents" };
            UpdateDefines(tenjin_ironsource, TypeExists(ironsourceTypes), new[] { BuildTargetGroup.iOS, BuildTargetGroup.Android });
        }
