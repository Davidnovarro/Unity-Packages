...
namespace TenjinSDK
{
    // @davitmk commented this out because Tenjin's SDK programmers are lazy and left this pointless class in the user's project. This shouldn't be here—it just adds an unnecessary menu item and clutters the user's project.
